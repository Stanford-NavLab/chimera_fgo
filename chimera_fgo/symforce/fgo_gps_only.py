...
from chimera_fgo.symforce.residuals import range_residual


def build_values(init_poses, satpos, m_ranges, range_sigma):
...
def fgo_gps_only(init_pos, sat_pos, m_ranges, range_sigma, gps_rate, fix_first_pose=False, debug=False):
    ...
    values = build_values(init_pos, sat_pos, m_ranges, range_sigma)
